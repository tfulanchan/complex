...
“**憑這沒落時的星辰發誓。**”穆佳黑德說，即以伴隨着黎明消逝的昴宿發誓。[^2] 端哈克認爲經文指：以打擊惡魔時的星星發誓。與這段經文相似的是下面的經文：`( 我以羣星的位置發誓。如果你們知道，那的確是一個重大的誓言。它確實是尊貴的《古蘭》。在被珍藏的天經中。只有潔淨者才能觸摸它。它是來自衆世界的主的啓示。)（56：75-80）`
