      ...
      <Layout title="互動問答" description="fields">
        <section className="bg-white dark:bg-gray-900">
          <div className="py-3 lg:py-5 px-4 mx-auto max-w-screen-md">
            ...
            <div
              class="bg-teal-100 dark:bg-indigo-900 border-t-4 border-teal-500 rounded-b text-teal-900 dark:text-teal-100 px-4 py-3 shadow-md"
              role="alert"
            >
              <div class="flex">
                <div class="py-1">
                  <svg
                    class="fill-current dark:fill-current h-6 w-6 text-teal-500 mr-4"
                ...
                <div>
                  <p>
                    此頁面需要網路連線才能正常運作。處於測試階段，機器回答提供的答案可能不準確，如內容有任何歧義或不一致之處，概以已出版內容為準。
                  </p>{" "}
                </div>
              </div>
            </div>
